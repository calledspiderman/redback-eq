...
.PHONY: linux-build linux-deb linux-rpm linux-appimage linux-clean

linux-build:
	@echo "Building Radioform for Linux..."
	@./tools/packaging/linux/build.sh

linux-deb:
	@echo "Building .deb package..."
	@./tools/packaging/linux/build-deb.sh

linux-rpm:
	@echo "Building .rpm package..."
	@rpmbuild -bb tools/packaging/linux/radioform.spec

linux-appimage:
	@echo "Building AppImage..."
	@./tools/packaging/linux/build-appimage.sh

linux-clean:
	@echo "Cleaning Linux build artifacts..."
	@rm -rf build/linux dist/radioform*.deb dist/Radioform*.AppImage
